...
// Core: autoload + env + container — NO include/app.php here.
require_once __DIR__ . '/vendor/autoload.php';
if (class_exists(Dotenv\Dotenv::class)) {
    Dotenv\Dotenv::createImmutable(__DIR__)->safeLoad();
}
// Build container (Pu239\Database, Cache, Logger etc.). Expose as global $container.
// DO NOT start sessions, DO NOT send headers, DO NOT include app.php here.
