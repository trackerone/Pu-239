...
final class UsercpHandler
{
    ...
    public function handle(array $meta = []): void
    {
        ...
        try {
            // TODO(2025): legacy target public/usercp.php:1-10 still throws RuntimeException placeholder; await rehydrated source
            ...
            ob_start();
            try {
                // TODO(2025): extract legacy flow manually (nested includes/globals). Legacy: public/usercp.php
                require $target;
