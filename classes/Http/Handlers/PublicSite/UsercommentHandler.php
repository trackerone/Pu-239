...
final class UsercommentHandler
{
    ...
    public function handle(array $meta = []): void
    {
        ...
        try {
            // TODO(2025): extract legacy block from public/usercomment.php:1-247 (multi-action comment controller with ExtendedPDO TODOs)
            ...
            ob_start();
            try {
                // TODO(2025): extract legacy flow manually (nested includes/globals). Legacy: public/usercomment.php
                require $target;
