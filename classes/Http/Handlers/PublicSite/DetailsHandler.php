...
final class DetailsHandler
{
    ...
    public function handle(array $meta = []): void
    {
        // AUTO_CONVERT_ATTEMPTED: 2025-10-21T04:35:34Z via handler-convert offset=345 batch=5
        try {
            $target = __DIR__ . '/../../../../public/details.php';
            if (!is_file($target)) {
            ...
            // TODO(2025): extract legacy block from public/details.php:1-1100 (torrent detail renderer w/ multi-service deps)
            ob_start();
            try {
                require $target;
