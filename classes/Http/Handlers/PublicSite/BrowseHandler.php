...
final class BrowseHandler
{
    /** @param array<string,mixed> $meta */
    public function handle(array $meta = []): void
    {
        // STUB_UPGRADED: safe buffered execution
        // TODO(2025): extract legacy block from public/browse.php:1-570 (complex FluentPDO filters + cached facets)
        $target = __DIR__ . '/../../../../public/browse.php';
        if (!is_file($target)) {
