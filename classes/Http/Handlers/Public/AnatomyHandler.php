    ...
    public function handle(array $meta = []): void
    {
        ...
        try {
            ...
            <div class='bg-03 padding20 round10 top20'>
                GET /announce.php?<span class='has-text-lightblue'>info_hash=c9791C5jG951BEC7MF9BFa03F22CEDEE0F</span>&amp;<span class='has-text-orange'>peer_id=S588-----gqQ8TqDeqaY</span>&amp;<span class='has-text-success'>port=6882</span>&amp;<span class='has-text-warning'>uploaded=0</span>&amp;<span class='has-text-lightgreen'>downloaded=0</span>&amp;<span class='has-text-jade'>left=753690875</span>&amp;<span class='has-text-turquoise'>event=started</span>
            </div>
            <div class='bg-03 padding20 round10 top20'>
                <div><?= _("Let's dissect this") ?>:</div>
            ...
            <div class='bg-03 padding20 round10 top20'>
                ...
                <div>
                    GET /announce.php?info_hash=c9791C5jG951BEC7MF9BFa03F22CEDEE0F&amp;peer_id=S588-----gqQ8TqDeqaY&amp;port=6882&amp;<span class='has-text-warning'>uploaded=67960832</span>&amp;<span class='has-text-success'>downloaded=40828928</span>&amp;left=715417851&amp;<span class='has-text-turquoise'>numwant=0</span>
                </div>
            </div>
            <div class='bg-03 padding20 round10 top20'>
                <ul class='disc left20'>
            ...
            <div class='bg-03 padding20 round10 top20'>
                ...
                <div>
                    GET /announce.php?info_hash=c9791C5jG951BEC7MF9BFa03F22CEDEE0F&amp;peer_id=S588-----gqQ8TqDeqaY&amp;port=6882&amp;uploaded=754384896&amp;downloaded=754215163&amp;<span class='has-text-jade'>left=0&amp;numwant=0&amp;<span class='has-text-turquoise'>event=completed</span></span>
                </div>
                <div>
            ...
            $wrapped = wrapper($content, 'has-text-left');
            $title = _('Anatomy of a Torrent');
            $breadcrumbs = [
                "<a href='{$config->get('paths.baseurl')}/browse.php'>" . _('Browse Torrents') . '</a>',
                "<a href='{$_SERVER['PHP_SELF']}'>$title</a>",
            ];
            echo stdhead($title, [], 'page-wrapper', $breadcrumbs) . wrapper($wrapped) . stdfoot();
        } catch (\Throwable $e) {
