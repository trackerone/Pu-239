...
final class UserSearchController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            // LEGACY BODY START (from admin/usersearch.php)
            // TODO(2025): extract user search form rendering
            // TODO(2025): add pagination
            require_once dirname(__DIR__, 2) . '/../include/helpers/audit.php';
            ...
            error_log('Admin controller error (usersearch): ' . $e->getMessage());
