...
final class CheatersController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            // TODO(2025): inline legacy logic from admin/cheaters.php (was using legacy require)
            ...
            error_log('Admin controller error (cheaters): ' . $e->getMessage());
