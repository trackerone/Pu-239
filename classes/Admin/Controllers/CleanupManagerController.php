...
final class CleanupManagerController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            require_once __DIR__ . '/../../../admin/cleanup_manager.legacy.php';
        } catch (\Throwable $e) {
            error_log('Admin controller error (cleanup_manager): ' . $e->getMessage());
