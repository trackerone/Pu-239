...
final class ReferrersController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            // LEGACY BODY START (from admin/referrers.php)
            // TODO(2025): wrap referrers report in AdminReportService
    ...
    <h1 class='has-text-centered'>" . _('Last referers') . '</h1>';
        ...
        <tr>
            ...
            error_log('Admin controller error (referrers): ' . $e->getMessage());
