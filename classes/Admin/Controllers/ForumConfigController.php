...
final class ForumConfigController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            $res = sql_query('SELECT delete_for_real, min_delete_view_class, readpost_expiry, min_upload_class, accepted_file_extension, accepted_file_types, max_file_size FROM forum_config WHERE id = ' . sqlesc($config_id)) or sqlerr(__FILE__, __LINE__);
            ...
            error_log('Admin controller error (forum_config): ' . $e->getMessage());
