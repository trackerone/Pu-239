...
final class ReputationSettingsController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            require_once __DIR__ . '/../../../admin/reputation_settings.legacy.php';
        } catch (\Throwable $e) {
            error_log('Admin controller error (reputation_settings): ' . $e->getMessage());
