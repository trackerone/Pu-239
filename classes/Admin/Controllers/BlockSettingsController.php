...
final class BlockSettingsController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            // TODO(2025): inline legacy logic from admin/block.settings.php (was using legacy require)
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                audit_log($CURUSER['id'] ?? null, 'config.update', ['keys' => array_values($updated)]);
            ...
            error_log('Admin controller error (block.settings): ' . $e->getMessage());
