...
final class SnatchedTorrentsController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            require_once __DIR__ . '/../../../admin/snatched_torrents.legacy.php';
        } catch (\Throwable $e) {
            error_log('Admin controller error (snatched_torrents): ' . $e->getMessage());
