...
final class ModdedTorrentsController
{
    ...
    public function __invoke(array $meta = []): void
    {
        ...
        try {
            ...
            require_once __DIR__ . '/../../../admin/modded_torrents.legacy.php';
        } catch (\Throwable $e) {
            error_log('Admin controller error (modded_torrents): ' . $e->getMessage());
