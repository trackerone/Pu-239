...
$db = $container->get(Database::class);, $site_config;
    ...
    $rows = $db->fetchAll('SELECT u.id, u.corrupt, a.corrupt FROM users AS u LEFT JOIN usersachiev AS a ON u.id = a.userid WHERE u.status = 0 AND u.corrupt >= 1 AND a.corrupt = 0');
