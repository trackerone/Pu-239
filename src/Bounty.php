...
class Bounty
{
    ...
    {
        try {
            $sql = "INSERT INTO bounties (/* columns */) VALUES (/* values */)";
$id = $this->db->perform($sql, $values);
    ...
    {
        try {
            $sql = "UPDATE bounties SET /* columns */ WHERE requestid = :requestid";
$id = $this->db->perform($sql, array_merge($update, ['requestid' => $requestid]));
