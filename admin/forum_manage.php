...
switch ($action) {
    case 'delete':
        ...
        Audit::log($CURUSER['id'] ?? null, 'config.update', ['keys' => ['forum_delete'], 'target' => $id]);
        header('Location: ' . $selfRaw . '?tool=forum_manage&action=forum_manage');
        app_halt('Exit called');
        break;
    ...
    case 'edit_forum':
        ...
        Audit::log($CURUSER['id'] ?? null, 'config.update', ['keys' => array_keys($set), 'target' => $id]);
        header('Location: ' . $selfRaw . '?tool=forum_manage&action=forum_manage');
        app_halt('Exit called');
        break;
    ...
    case 'add_forum':
        ...
        Audit::log($CURUSER['id'] ?? null, 'config.update', ['keys' => array_keys($values), 'target' => null]);
        header('Location: ' . $selfRaw . '?tool=forum_manage&action=forum_manage');
        app_halt('Exit called');
        break;
