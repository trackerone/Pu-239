...
if (empty($mode)) {
    $backups = $fluent$sql = "SELECT * FROM 'dbbackup'"; $this->db->fetchAll($sql);;
    ...
    if (!empty($ids)) {
        ...
        $files = $fluent$sql = "SELECT * FROM 'dbbackup'"; $this->db->fetchAll($sql);;
        ...
        if ($files) {
            ...
            $fluent$sql = "DELETE FROM 'dbbackup' WHERE ..."; $this->db->perform($sql);;
