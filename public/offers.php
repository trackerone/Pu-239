            ...
            $body .= "
                    <tr>
                        ...
                        <td class='has-text-centered'>" . ($has_full_access ? "
                            <a href='{$_SERVER['PHP_SELF']}?action=edit_offer&amp;id={$offer['id']}' class='tooltipper' title='" . _('Edit Offer') . "'><i class='icon-edit icon has-text-info' aria-hidden='true'></i></a>
                            <a href='{$_SERVER['PHP_SELF']}?action=delete_offer&amp;id={$offer['id']}' class='tooltipper' title='" . _('Delete Offer') . "'><i class='icon-trash-empty icon has-text-danger' aria-hidden='true'></i></a>" : '') . '
                        </td>' : '') . '
                    </tr>';
        }
    } else {
