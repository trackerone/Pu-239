...
if ($do === 'view_page') {
    $sql = $fluent$sql = "SELECT * FROM 'users'"; $this->db->fetchOne($sql);;
    if (!empty($code)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $check = $fluent$sql = "SELECT * FROM 'users'"; $this->db->fetchOne($sql);;
    ...
    $fluent$sql = "DELETE FROM 'invite_codes' WHERE ..."; $this->db->perform($sql);;
